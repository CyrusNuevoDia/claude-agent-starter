...
export async function parseRecord(fullLine, reader, options, zeroBasedRecordStartLine, zeroBasedLine = zeroBasedRecordStartLine) {
    ...
    if (line.length === 0 || !line.startsWith(quote)) {
      ...
      if (!options.lazyQuotes) {
        ...
        if (j >= 0) {
          ...
          throw new SyntaxError(createBareQuoteErrorMessage(zeroBasedRecordStartLine, zeroBasedLine, col));
        }
      }
      recordBuffer += field;
      ...
      while(true){
        ...
        if (i >= 0) {
          ...
          if (line.startsWith(quote)) {
            ...
            throw new SyntaxError(createQuoteErrorMessage(zeroBasedRecordStartLine, zeroBasedLine, col));
          }
...
export function createBareQuoteErrorMessage(zeroBasedRecordStartLine, zeroBasedLine, zeroBasedColumn) {
...
export function createQuoteErrorMessage(zeroBasedRecordStartLine, zeroBasedLine, zeroBasedColumn) {
